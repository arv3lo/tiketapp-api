import type { ITicketCategoryRepository } from "./ports/ticket-category.repository.interface";
import type { TicketCategoryInput, TTicketCategory } from "./ports/ticket-category.schema";
